...
<body>
    ...
    <section>
        ...
        <aside>
        <img class="macchina" src="..\res\macchine\macchina4.png">
        <img class="macchina" src="..\res\macchine\macchina3.png">
        <img class="macchina" src="..\res\macchine\macchina2.png">
        <img class="macchina" src="..\res\macchine\macchina1.png">
        </aside>
        <article>
            <div class="articolo">
                ...
                <h5><img class="info" src="..\res\IconaInfo.png">Aggiungi al carrello e confronta i prezzi in base al chilometraggio.</h5>
            </div>
            <div class="articolo">
