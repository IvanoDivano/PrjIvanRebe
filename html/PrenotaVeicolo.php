...
<body>
    ...
    <section>
        ...
        <aside>
        <img class="macchina" alt="Immagine Rangerover bianco" href="..\res\macchine\macchina4.png">
        <img class="macchina" alt="Immagine BMW bianca" href="..\res\macchine\macchina3.png">
        <img class="macchina" alt="Immagine BMW Suv bianco" href="..\res\macchine\macchina2.png">
        <img class="macchina" alt="Immagine tesla bianca" href="..\res\macchine\macchina1.png">
        </aside>
        <article>
            <div class="articolo">
                ...
                <button>Prenota</button><img class="carrello" alt="icona carrello" href="..\res\IconaCarrello.png">
                <h5><img class="info" alt="icona informazioni" href="..\res\IconaInfo.png">Se non sei sicuro, aggiungi al carrello e confronta i prezzi in base <br> al chilometraggio.</h5>
            </div>
            <div class="articolo">
